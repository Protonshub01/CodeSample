...
export default StyleSheet.create({
    ...
    labelSticker: {
        ...
        backgroundColor: COLOR_CONST.primaryThemeColor,
        position: 'absolute',
        left: 0,
        top: verticalScale(16),
        justifyContent: 'center',
    ...
    price: {
        ...
        lineHeight: scale(18),
        // height: scale(18),
        // color: themeJson.config.commonPriceColor,
    ...
    addToCartContainer: {
        ...
        alignItems: 'center',
        width: scale(164),
        // backgroundColor: themeJson.config.viewMoreButtonBgColor,
        height: scale(40)
    },

    addToCartText: {
        // color: themeJson.config.viewMoreButtonTitleColor,
        alignSelf: 'center',
        // fontFamily: FONTS.GTWalsheimProRegular,
        fontSize: scale(13),
        lineHeight: scale(15),
    ...
    loginButton: {
        ...
        ...Platform.select({
            ios:{
                marginBottom: verticalScale(45.2),
            },
            android:{
                marginBottom: verticalScale(75.2),
            }
        })
